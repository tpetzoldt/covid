...
so we can estimate the growth rate $r$ as:
...
The same can be repeated with a lag time $\Delta t > 1$day, for example 
one week ($\Delta t > 7$):
...
An alternative to the rate of increase is the doubling time. Here higher values 
